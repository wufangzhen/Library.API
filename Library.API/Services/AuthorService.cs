...
namespace Library.API.Services
{
    public class AuthorService :IAuthorService
    {
        ...
        private readonly IRepositoryBase<Author, Guid> AuthorRepository;

        public AuthorService(IRepositoryBase<Author,Guid> authorRepository) 
        {
        ...
        {
            IQueryable<Author> queryableAuthors = AuthorRepository.GetAll();
