using AutoMapper;
using Library.API.Common.ComplexAuthenticate;
...
namespace Library.API.Controllers
{
    ...
    public class BookController : ControllerBase
    {
        ...
        public BookController(IBookService bookService,
            IRepositoryBase<Book,Guid> bookRepository,
            IMapper mapper,
        ...
        IRepositoryBase<Book, Guid> BookRepository { get; }
        ...
        public async Task<ActionResult<ResourceCollection<BookDto>>> GetBooksAsync(Guid authorId)
        {
            ...
            {
                var books = await BookService.GetBooksAsync(authorId);
            ...
            return Ok(CreateLinksForBooks(bookList));
        }
